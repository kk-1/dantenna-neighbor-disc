...
def update(frame, antennas, ax):
    ...
    time_step = frame
    # ts = ts +1
    # print("Frame:",frame, time_step, ts)
    for antenna in antennas:
...
try:
    ...
    # Set the seeds
    newseed = int(sys.argv[5])
    np.random.seed(newseed)
    random.seed(newseed)

    # print(ALPHA, GAMMA, EPSILON, theN, theM, newseed)
    # print(ALPHA, GAMMA, EPSILON, theN, theM)
except:
    e = sys.exc_info()[0]
    print(e)
